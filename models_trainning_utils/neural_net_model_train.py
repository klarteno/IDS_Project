...
class ModelsEvaluations:
    ...
    def get_multi_class_accuracies_trainning_score(self):
        with torch.no_grad():
            ...
            _multi_class_accuracies = torch.stack(self.multi_class_accuracies_trainning, dim=0)
            ...
            for i in range(_shape[1]):
                ...
                total_multi_class_accuracies.append(np.around(_mean_value.item() * 100, decimals=2)              )
    ...
    def get_evaluations_score(self):
        ...
        return accuracy_trainning.item(), f1_score_trainning.item(), auroc_trainning.item()
