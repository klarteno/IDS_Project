...
def save_optimization_study(study, model_name:ModelsNames, evaluation_function):     
    ...
    path_study= "models_generated" + "//" + model_name_str+"_study_"  + evaluation_function +".pkl"
...
def capture_notebook_cell(model_name,evaluation_function):
    ...
    with open( (model_name.name).lower() + "_study_"+ evaluation_function+ "_output.txt", 'w') as f:
